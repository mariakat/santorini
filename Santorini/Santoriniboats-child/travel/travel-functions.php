...
if (!function_exists('travel_connect_to_db')) :
    ...
    {
        $db = new MysqliDb('localhost', 'santorin_wp831', 'ep8-G9]2So', 'santorin_wp831');
        return $db;
    }
endif;
...
add_filter('woocommerce_before_add_to_cart_form','test');   
function test(){
...
// function santorini_last_booking_captain()
// {
//     global $product;
//     $altMessage = '';
//     $bookingShips = array('1');
//     $fulldayBookingId = 1558;
//     $halfdayBookingId = 1552;
//     $sunsetBookingId = 1555;
//     $bookingInfo = array();
//     $product_id = $product->get_id();
...
// add_action('wp_ajax_santorini_last_booking', 'santorini_last_booking');
// add_action('wp_ajax_nopriv_santorini_last_booking', 'santorini_last_booking_captain');
