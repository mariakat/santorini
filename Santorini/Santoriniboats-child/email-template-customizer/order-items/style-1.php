    ...
    <tr>
        <td style='<?php echo esc_attr( $th_style_left ) ?>'>
			...
			wc_display_item_meta(
				$item,
				array(
					'before'       => '<style>.items div{;margin:10px 0;} .items div:last-child{display:none!important;}.wc-item-meta-label{font-weight:400!important;}</style><div class="items"><div>',
					'after'        => '</div></div>',
					'separator'    => '</div><div>',
...
$out = $html . ob_get_clean() . '</table>test';
